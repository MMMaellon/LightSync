...
{
    [InitializeOnLoad]
    public class LightSyncDefineManager
    {
        static LightSyncDefineManager()
        {
            AddDefinesIfMissing(EditorUserBuildSettings.selectedBuildTargetGroup, new string[] { "MMM_LIGHTSYNC", "MMM_LIGHTSYNC_V1" });
        }
